...
class KlasaReady extends Event {
    ...
    async run() {
        ...
        if (res.status !== 200) Object.defineProperty(this.client.constructor.prototype, "spotifyToken", { value: null });
        Object.defineProperty(this.client.constructor.prototype, "spotifyToken", { value: res.body.access_token });
        res.status !== 200 ? 
